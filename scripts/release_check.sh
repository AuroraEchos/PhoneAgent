...
echo "[1/8] Checking forbidden tracked files"
...
echo "[2/8] Checking placeholders and likely credentials"
if grep -RInE \
...
echo "[5/8] Checking Web Console modules"
