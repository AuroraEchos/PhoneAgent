...
const translations = {
  en: {
    ...
    "hero.eyebrow": "Open source · v0.1.4 Alpha",
    ...
    "trajectory.release": "Read the v0.1.4 release notes",
    ...
    "limitations.title": "Honest about what v0.1.4 can prove.",
  ...
  zh: {
    ...
    "backToTop": "返回顶部",
    "hero.eyebrow": "开源项目 · v0.1.4 Alpha",
    ...
    "trajectory.release": "阅读 v0.1.4 发布说明",
    "roadmap.kicker": "开发路线",
    ...
    "limitations.title": "如实表达 v0.1.4 能够证明什么。",
...
const derivedLinks = {
  ...
  release: `${repositoryUrl}/releases/tag/v0.1.4`,
