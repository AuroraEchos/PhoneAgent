...
const translations = {
  en: {
    ...
    "hero.eyebrow": "Open source · v0.1.2 Alpha",
    ...
    "architecture.description": "Only a high-confidence pure open-app goal takes the deterministic launch shortcut. Other tasks follow the explicit observe, plan, execute, verify, and recover loop.",
    ...
    "trajectory.release": "Read the v0.1.2 release notes",
    ...
    "limitations.title": "Honest about what v0.1.2 can prove.",
  ...
  zh: {
    ...
    "backToTop": "返回顶部",
    "hero.eyebrow": "开源项目 · v0.1.2 Alpha",
    ...
    "architecture.description": "只有高置信度的纯打开应用目标会采用确定性启动捷径；其他任务严格进入观察、规划、执行、验证与恢复闭环。",
    ...
    "trajectory.release": "阅读 v0.1.2 发布说明",
    "roadmap.kicker": "开发路线",
    ...
    "limitations.title": "如实表达 v0.1.2 能够证明什么。",
...
const derivedLinks = {
  ...
  release: `${repositoryUrl}/releases/tag/v0.1.2`,
