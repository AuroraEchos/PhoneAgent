...
const translations = {
  en: {
    ...
    "hero.eyebrow": "Open source · v0.2.0 Research Release",
    ...
    "trajectory.release": "Read the v0.2.0 release notes",
    "roadmap.kicker": "Roadmap",
    "roadmap.title": "The runtime is small by design. The direction is not.",
    "roadmap.description": "v0.2.0 freezes the final architecture baseline. The project now moves into real-device evaluation, regression, and maintenance.",
    ...
    "roadmap.item5.description": "Externally annotated trajectory metrics and recorded real-device regression.",
    ...
    "limitations.title": "Honest about what v0.2.0 can prove.",
    ...
    "limitations.item2.description": "The planner reports runtime completion through finish(...); published task correctness still requires an external annotation or deterministic judge.",
  ...
  zh: {
    ...
    "trajectory.release": "阅读 v0.2.0 发布说明",
    "roadmap.kicker": "开发路线",
    "roadmap.title": "核心运行时刻意保持简单，但发展方向并不狭窄。",
    "roadmap.description": "v0.2.0 冻结最后一版架构基线。项目从此转入真机评测、回归测试与维护阶段。",
    ...
    "roadmap.item5.description": "外部标注的轨迹指标与有记录的真机回归。",
    ...
    "limitations.title": "如实表达 v0.2.0 能够证明什么。",
    ...
    "limitations.item2.description": "模型通过 finish(...) 报告运行时完成；公开任务正确率仍需外部标注或确定性评审器。",
...
const derivedLinks = {
  ...
  release: `${repositoryUrl}/releases/tag/v0.2.0`,
